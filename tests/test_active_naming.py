...
HISTORY_FILES = {
    ...
    "docs/evidence/theustad-1.0/robustness/README.md",
    "docs/evidence/theustad-1.0/robustness/a1-audit.jsonl",
    "docs/evidence/theustad-1.0/robustness/a1.txt",
    "docs/evidence/theustad-1.0/robustness/a2-audit.jsonl",
    "docs/evidence/theustad-1.0/robustness/a2.txt",
    "docs/evidence/theustad-1.0/robustness/a3-audit.jsonl",
    "docs/evidence/theustad-1.0/robustness/a3.txt",
    "docs/evidence/theustad-1.0/robustness/a4-audit.jsonl",
    "docs/evidence/theustad-1.0/robustness/a4.txt",
    "docs/evidence/theustad-1.0/robustness/a5-audit.jsonl",
    "docs/evidence/theustad-1.0/robustness/a5.txt",
    "docs/evidence/theustad-1.0/robustness/b1-audit.jsonl",
    "docs/evidence/theustad-1.0/robustness/b1.txt",
    "docs/evidence/theustad-1.0/robustness/b2-audit.jsonl",
    "docs/evidence/theustad-1.0/robustness/b2.txt",
    "docs/evidence/theustad-1.0/robustness/b3-1-audit.jsonl",
    "docs/evidence/theustad-1.0/robustness/b3-1.txt",
    "docs/evidence/theustad-1.0/robustness/b3-10-audit.jsonl",
    "docs/evidence/theustad-1.0/robustness/b3-10.txt",
    "docs/evidence/theustad-1.0/robustness/b3-2-audit.jsonl",
    "docs/evidence/theustad-1.0/robustness/b3-2.txt",
    "docs/evidence/theustad-1.0/robustness/b3-3-audit.jsonl",
    "docs/evidence/theustad-1.0/robustness/b3-3.txt",
    "docs/evidence/theustad-1.0/robustness/b3-4-audit.jsonl",
    "docs/evidence/theustad-1.0/robustness/b3-4.txt",
    "docs/evidence/theustad-1.0/robustness/b3-5-audit.jsonl",
    "docs/evidence/theustad-1.0/robustness/b3-5.txt",
    "docs/evidence/theustad-1.0/robustness/b3-6-audit.jsonl",
    "docs/evidence/theustad-1.0/robustness/b3-6.txt",
    "docs/evidence/theustad-1.0/robustness/b3-7-audit.jsonl",
    "docs/evidence/theustad-1.0/robustness/b3-7.txt",
    "docs/evidence/theustad-1.0/robustness/b3-8-audit.jsonl",
    "docs/evidence/theustad-1.0/robustness/b3-8.txt",
    "docs/evidence/theustad-1.0/robustness/b3-9-audit.jsonl",
    "docs/evidence/theustad-1.0/robustness/b3-9.txt",
    "docs/evidence/theustad-1.0/robustness/b4-tampered-copy.jsonl",
    "docs/evidence/theustad-1.0/robustness/b4.txt",
    "docs/evidence/theustad-1.0/robustness/environment.txt",
    "docs/evidence/theustad-1.0/robustness/sha256sums.txt",
    "docs/evidence/theustad-1.0/robustness/summary.json",
    "docs/evidence/theustad-1.0/robustness/summary.txt",
    "docs/evidence/theustad-1.0/robustness/test_suite.txt",
}
COMPATIBILITY_PATHS = {
...
ALLOWED_OCCURRENCES = {
    ...
    "README.md": exact_lines(
        (153, "## Upgrade from <display>"),
        (155, "**Formerly <display>**, TheUstad is the canonical product and runtime. <display>-named"),
        (167, "`$theustad:*` names for all new work. <display> artifacts below are historical"),
    ...
    "docs/PLUGIN_GUIDE.md": exact_lines(
        (114, "## <display> migration and history"),
        (116, "<display>-named commands are deprecated migration adapters through TheUstad 1.x."),
        (117, "Existing automation may temporarily use `<lower>.py`, `<lower>lib`, `<upper>_STATE_HOME`,"),
        (118, "`<upper>_PYTHON`, `<lower>@personal`, and `$<lower>:*`; all new commands use TheUstad."),
    ),
    ...
    "tests/test_plugin_package.py": exact_lines(
        ...
        (602, '        "Formerly <display>",'),
        (652, '    assert "<upper>_DOCTOR_OK" in release_installation'),
        (658, '    assert "SUPPORTED_<upper>_RUN NOT RUN" in real_demo'),
    ),
